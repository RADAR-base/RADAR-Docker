...
4. Move `etc/managementportal/oauth_client_details.csv.template` to `etc/managementportal/oauth_client_details.csv` and change OAuth client credentials for production MP. (Except ManagementPortalapp)
