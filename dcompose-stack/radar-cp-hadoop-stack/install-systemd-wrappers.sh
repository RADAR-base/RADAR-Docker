...
inline_variable 'WorkingDirectory=' "$DIR/hdfs" /etc/systemd/system/radar-output.service
inline_variable 'ExecStart=' "$DIR/bin/hdfs-restructure-process" /etc/systemd/system/radar-output.service
